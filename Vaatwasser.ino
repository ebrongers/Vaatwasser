...
//WIFI
// Landstede-Specials
const char* ssid = "Landstede-Specials";
// const char* ssid = "Ziggo1546241";
//dnwLEmspw1865UUkzh
// const char* password = "xtrcpfHVj8fw";
const char* password = "dnwLEmspw1865UUkzh";
...
//------------------------------------------
void HandleRoot(){
  String message = "<html><body> Description: Temperature\r\n<br />";
